...
for t in range(64, 179):
  Acc[t] = ((F2 - Ftyag(m2-1818*(t+1), Altitude[t])) / m2)
#  if t+1 < 188:
#    H[t+1] = (Acc[t]*((t+1)**2))/2
...
#  print("Time:", t, "Velocity:", 1.6*v, "Height:", h*0.8) #Вывод промежуточных данных
  V.append(1.6*v)
  dM -= k1 #уменьшение топлива на единицу затраты
  v0 = velocity(v, h, m1_without_fuel + dM, m1_without_fuel + dM + k1)
  hm.append(h*0.8)
  h += (v + v0)*0.5
  v = v0
  t += 1
...
#  print("Time:", t, "Velocity:", 1.4*v, "Height:", h*0.8) #Вывод промежуточных данных
  V.append(1.4*v)
  dM -= k2
  v0 = velocity(v, h, m2_without_fuel + dM, m2_without_fuel + dM + k2)
  hm.append(h*0.8)
  h += (v + v0)*0.5
  v = v0
  t += 1
